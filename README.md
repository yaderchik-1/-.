...
<html>
<head>
<title>Токарь — специалист по обработке резаньем вращающихся заготовок или вращающегося режущего инструмента (токарь-расточник) по обработке дерева, металла, пластмассы, смолы и т. д.. 
...
<frameset cols="100,*">
<frame name="links" src="токарь_ind.html"/>
<frame name="contents" src="токарь-1.html"/>
</frameset>
</html>
